...
import logoSquareImage from "../images/logo_square.png";
import logoSmallImage from "../images/logo_small.png";
      ...
      <MuiThemeProvider muiTheme={getMuiTheme(lightBaseTheme)}>
        <div className="app">
          <div className="github">
            <a className="target" target="_blank" href="https://github.com/lostpebble/react-validate">
              <div className="box">
                <GithubIcon />
              </div>
            </a>
